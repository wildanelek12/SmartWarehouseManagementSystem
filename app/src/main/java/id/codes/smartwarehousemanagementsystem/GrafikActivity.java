...
public class GrafikActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseDatabase.getInstance().getReference("chart").child("chart_suhu").limitToLast(5).orderByChild("waktu").addValueEventListener(new ValueEventListener() {
            @Override
                ...
                if (dataSnapshot.exists()) {
                    for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                        ...
                        try {
                            ...
                            seriesData.add(new CustomDataEntry(formattedTime, dataSuhu.getSuhu()));
